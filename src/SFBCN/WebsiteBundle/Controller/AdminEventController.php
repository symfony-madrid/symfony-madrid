...
use SFBCN\WebsiteBundle\Form\EventType;
...
class AdminEventController extends Controller
{
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SFBCNWebsiteBundle:Event')->find($id);
     ...
     * @Method("post")
     * @Template("SFBCNWebsiteBundle:Event:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("SFBCNWebsiteBundle:Event:edit.html.twig")
     */
